...
namespace ConsultantDashboard.Infrastructure.Migrations
{
    ...
    [Migration("20250708101628_addconsultantlocation_entity")]
    partial class addconsultantlocation_entity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ConsultantDashboard.Core.Entities.ConsultantLocation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("ConsultantDashboard.Core.Entities.PlanBufferRule", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("ConsultantLocationId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("PlanId", "ConsultantLocationId")
                        .IsUnique();

                    b.ToTable("PlanBufferRules");
                });
            ...
            modelBuilder.Entity("ConsultantDashboard.Core.Entities.ConsultantLocation", b =>
                {
                    b.HasOne("ConsultantDashboard.Core.Entities.ConsultantProfile", "Consultant")
                        .WithMany("ConsultantLocations")
            ...
            modelBuilder.Entity("ConsultantDashboard.Core.Entities.ConsultantProfile", b =>
                {
                    b.Navigation("ConsultantLocations");
                });
