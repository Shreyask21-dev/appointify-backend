...
namespace ConsultantDashboard.Infrastructure.Migrations
{
    ...
    [Migration("20250708111834_addconsultantshift_table")]
    partial class addconsultantshift_table
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ConsultantDashboard.Core.Entities.Shift", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ConsultantDashboard.Core.Entities.PlanBufferRule+PlanShiftBufferRule", b =>
                {
                    ...
                    b.HasOne("ConsultantDashboard.Core.Entities.Shift", "Shift")
                        .WithMany()
