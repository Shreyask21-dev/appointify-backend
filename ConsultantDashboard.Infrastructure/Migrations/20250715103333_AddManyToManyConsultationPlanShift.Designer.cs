...
namespace ConsultantDashboard.Infrastructure.Migrations
{
    ...
    [Migration("20250715103333_AddManyToManyConsultationPlanShift")]
    partial class AddManyToManyConsultationPlanShift
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ConsultantShiftConsultationPlan", b =>
                {
                    b.Property<Guid>("ConsultantShiftsId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("PlansPlanId")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("ConsultantShiftsId", "PlansPlanId");

                    b.HasIndex("PlansPlanId");

                    b.ToTable("ConsultantPlanShifts", (string)null);
                });
            ...
            modelBuilder.Entity("ConsultantShiftConsultationPlan", b =>
                {
                    b.HasOne("ConsultantDashboard.Core.Entities.ConsultantShift", null)
                        .WithMany()
                        .HasForeignKey("ConsultantShiftsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ConsultantDashboard.Core.Entities.ConsultationPlan", null)
                        .WithMany()
